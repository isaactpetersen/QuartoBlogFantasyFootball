...
Below are sections for common questions/issues/warnings/errors in [`R`](#sec-troubleshootingR) and [`GitHub Pages`](#sec-troubleshootingGitHubPages) (that I will populate as I receive questions), and how to info on how to address them.
