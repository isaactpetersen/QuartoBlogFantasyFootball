...
This section should describe your research question(s) and hypotheses, and should provide a justification for each hypothesis—ideally based on prior work, theory, etc.
It should also describe why your study is innovative and important.
The research question(s) should be clear.
...
This section describes the data you used—including the subset of players, positions, seasons, and indices you examined—and how you obtained them.
